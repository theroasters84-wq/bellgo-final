...
export const I18n = {
    ...
    builtIn: {
        en: {
            ...
            staff_pin_sub: "Set PIN for employees",
            total: "TOTAL",
            unlock: "UNLOCK",
        ...
        el: {
            ...
            staff_pin_title: "PIN ΠΡΟΣΩΠΙΚΟΥ",
            staff_pin_sub: "Ορίστε κωδικό για τους υπαλλήλους",
            total: "ΣΥΝΟΛΟ",
            unlock: "ΞΕΚΛΕΙΔΩΜΑ",
    ...
    if (isAndroid && isStaff) {
        ...
        fetch('https://api.github.com/repos/theroasters84-wq/bellgo-final/releases/latest')
            ...
            .then(data => {
                ...
                // ✅ Εκκίνηση ελέγχου από την v.0.7 (Αν δεν έχει καταγραφεί άλλη έκδοση)
                const installedVersion = localStorage.getItem('bellgo_apk_version') || 'v.0.7';
