export const Sundromes = {
    packages: [
        ...
        { 
            ...
            ui_ids: ['resWrapper', 'btnShowLink', 'btnSettings', 'btnFakeLock', 'btnSettingsQr', 'btnSettingsGeneral', 'btnMenuToggle', 'btnSettingsStore', 'rowSwitchCust'] // ✅ Customers (Delivery) HERE
        },
        { 
            key: 'pack_tables', 
