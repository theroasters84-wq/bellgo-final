...
export const PaySystem = {
    ...
    triggerSoftPosPayment: (amount, context) => {
        ...
        if (s.provider === 'viva') {
            ...
            // ✅ Generic App Launcher Intent: Ανοίγει την εφαρμογή εγγυημένα ή πάει στο PlayStore αν δεν υπάρχει
            ...
            // ✅ Εμφάνιση παραθύρου επιβεβαίωσης επειδή αυτές οι τράπεζες δεν επιστρέφουν αυτόματα (όπως η Viva)
            setTimeout(() => {
